...
public final class Coin implements Monetary, Comparable<Coin>, Serializable {
    ...
    public static final Coin ONE_KIBI_COINS = COIN.multiply(1024);
    ...
    public boolean isGreaterEqualsThan(Coin other) {
        return compareTo(other) >= 0;
    }
    ...
    public boolean isLessEqualsThan(Coin other) {
        return compareTo(other) <= 0;
    }
    ...
    private static final MonetaryFormat FRIENDLY_FORMAT = MonetaryFormat.DMC.minDecimals(2).repeatOptionalDecimals(1, 6).postfixCode();
    ...
    private static final MonetaryFormat PLAIN_FORMAT = MonetaryFormat.DMC.minDecimals(0).repeatOptionalDecimals(1, 8).noCode();
