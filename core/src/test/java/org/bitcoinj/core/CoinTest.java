...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 DMC", COIN.toFriendlyString());
        assertEquals("1.23 DMC", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 DMC", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 DMC", valueOf(1, 23).negate().toFriendlyString());
    }
