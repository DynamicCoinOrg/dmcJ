...
public class BtcFormatTest {
    ...
    public void parseTest() throws java.text.ParseException {
        ...
        assertEquals(valueOf(200000000), us.parseObject("2"));
        assertEquals(valueOf(200000000), usCoded.parseObject("DMC 2"));
    ...
    public void parseMetricTest() throws ParseException {
        ...
        // coin
        assertEquals(parseCoin("1"), cp.parseObject("DMC 1.00"));
        ...
        // megacoins
        assertEquals(parseCoin("1234567"), cp.parseObject("MDMC 1.234567"));
    ...
    public void currencyCodeTest() {
        ...
        assertEquals("DMC 1.00", usCoded.format(COIN));
        ...
        assertEquals("1,00 DMC", frCoded.format(COIN));
        ...
        assertEquals("DMC 1,00", deCoded.format(COIN));
    }
    ...
    public void autoDecimalTest() {
        ...
        assertEquals("DMC 1", codedZero.format(COIN));
        ...
        assertEquals("DMC 1,000", codedZero.format(COIN.multiply(1000)));
        ...
        assertEquals("DMC 1.00", codedTwo.format(COIN));
        ...
        assertEquals("DMC 1,000.00", codedTwo.format(COIN.multiply(1000)));
        ...
        assertEquals("DMC 1.000", codedThree.format(COIN));
        ...
        assertEquals("DMC 1,000.000", codedThree.format(COIN.multiply(1000)));
    ...
    public void symbolsCodesTest() {
        ...
        BtcFixedFormat symbolCoin = (BtcFixedFormat)BtcFormat.builder().locale(US).scale(0).
                                                              symbol("B\u20e6").build();
        assertEquals("DMC", symbolCoin.code());
        ...
        BtcFixedFormat symbolMega = (BtcFixedFormat)BtcFormat.builder().locale(US).scale(-6).
                                                              symbol("B\u20e6").build();
        assertEquals("MDMC", symbolMega.code());
    ...
    public void negativeTest() throws Exception {
        assertEquals("-1,00 DMC", BtcFormat.getInstance(FRANCE).format(COIN.multiply(-1)));
        assertEquals("DMC -1,00", BtcFormat.getInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("฿ -1,00", BtcFormat.getSymbolInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("DMC -1.00", BtcFormat.getInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("฿-1.00", BtcFormat.getSymbolInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("(DMC 1.00)", BtcFormat.getInstance(US).format(COIN.multiply(-1)));
        ...
        assertEquals("DMC -๑.๐๐", BtcFormat.getInstance(new Locale("th","TH","TH")).format(COIN.multiply(-1)));
    ...
    public void attributeTest() throws Exception {
        ...
        assertTrue(codePat.contains("DMC") && ! codePat.contains("(^|[^฿])฿([^฿]|$)") && ! codePat.contains("(^|[^¤])¤([^¤]|$)"));
        String symPat = BtcFormat.getSymbolInstance(Locale.US).pattern();
        assertTrue(symPat.contains("฿") && !symPat.contains("DMC") && !symPat.contains("¤¤"));

        assertEquals("DMC #,##0.00;(DMC #,##0.00)", BtcFormat.getCodeInstance(Locale.US).pattern());
    ...
    public void toStringTest() {
        ...
        assertEquals("Auto-format DMC #,##0.00;(DMC #,##0.00)", BtcFormat.getCodeInstance(Locale.US).toString());
        assertEquals("Auto-format DMC #,##0.0000;(DMC #,##0.0000)", BtcFormat.getCodeInstance(Locale.US, 4).toString());
    ...
    public void patternDecimalPlaces() {
        ...
        assertEquals("Millicoin-format DMC #.000;DMC -#.000", f.toString());
    ...
    public void builderTest() {
        ...
        assertEquals("DMC -1,00", built.format(COIN.multiply(-1)));
